    ...
    >
      <div className="p-6 md:p-6 lg:p-8 bg-white shadow-md rounded-xl">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col">
          ...
          />
          <button type="submit" className="bg-primary hover:bg-gradient-to-r from-primary to-slate-400 transition duration-200 ease-in-out text-white p-2 rounded" disabled={loading}>
