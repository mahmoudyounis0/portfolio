...
export default function AboutMe() {
  return (
    <main className=" min-h-screen flex justify-center items-center w-full bg-primary md:py-10 max-sm:py-5 ">
      <div
        ...
        <div className="knowMe flex max-sm:flex-col justify-center items-center gap-10 max-sm:gap-5 bg-supcolor max-w-6xl max-sm:w-auto p-5 rounded-lg bg-no-repeat bg-contain bg-right  max-sm:mx-2">
          ...
          <div className="flex flex-col justify-between items-start gap-5">
            <div data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
              <h1 className="text-[clamp(1.5rem,4vw,2.25rem)] font-kanit font-semibold text-fonts mb-2 uppercase">
                About me
              </h1>
            ...
            <Link
              ...
              data-aos-delay="300"
              target="_blank"
              className="link relative transition-all flex items-center px text-fonts border-solid border-primary border-2 rounded-lg px-16   max-sm:mb-5 py-3 w-fit justify-center focus-visible:ring-2 focus-visible:ring-morning hover:scale-[1.02] active:scale-[0.98]"
            >
